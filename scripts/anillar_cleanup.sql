...
DELETE FROM estacions WHERE id BETWEEN 20001 AND 20200;
...
DELETE FROM estacions WHERE id BETWEEN 30001 AND 30200;
...
UNION ALL
SELECT 'estacions', count(*) FROM estacions WHERE id BETWEEN 20001 AND 30200
UNION ALL
