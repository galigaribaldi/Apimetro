...
const docTemplate = `{
    ...
    "paths": {
        "/analitico/afluencia-estacion": {
            "get": {
                "description": "Retorna registros de afluencia mensual por estación desde ` + "`" + `plutarco.afluencia_estacion` + "`" + `.\nGranularidad: 1 fila = 1 estación × 1 mes × 1 año.\nSolo sistema Metro (STC) — los demás sistemas no publican datos por estación.\nDatos fuente: STC Metro / datos.cdmx.gob.mx (CC BY 4.0).\nTotal actual: 38,219 registros (195 estaciones, 12 líneas, 2010-2026).",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID de la línea Metro (ref: public.lineas.id)",
                        "name": "linea_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Número comercial de la línea. Ej: 1, A, L12",
                        "name": "num_comercial",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "ID de la estación (ref: public.estacions.id)",
                        "name": "estacion_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Nombre de la estación (búsqueda parcial, ILIKE). Ej: Pantitlán",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.AfluenciaEstacionResponse"
                        }
                    },
                    "404": {
    ...
    "definitions": {
        "models.AfluenciaEstacion": {
            ...
            "properties": {
                ...
                "fuente": {
                    "type": "string",
                    "example": "STC-Metro-DatosAbiertos"
                },
                "linea_id": {
                    "type": "integer",
                    "example": 191
        ...
        "models.AfluenciaEstacionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AfluenciaEstacion"
                    }
                },
                "total": {
                    "type": "integer",
